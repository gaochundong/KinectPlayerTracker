...
namespace KinectPlayerTracker.Toolkit
{
    public class KinectSensorChooser : INotifyPropertyChanged
    {
        ...
        private string _requiredConnectionId;

        #region Events

        private readonly ContextEventWrapper<KinectSensorChangedEventArgs<KinectSensor>> _kinectSensorChangedContextWrapper =
            new ContextEventWrapper<KinectSensorChangedEventArgs<KinectSensor>>(ContextSynchronizationMethod.Post);

        private readonly ContextEventWrapper<PropertyChangedEventArgs> _propertyChangedContextWrapper =
            new ContextEventWrapper<PropertyChangedEventArgs>(ContextSynchronizationMethod.Post);

        private readonly Dictionary<PropertyChangedEventHandler, EventHandler<PropertyChangedEventArgs>> _changedHandlers =
        ...
        /// </summary>
        public event EventHandler<KinectSensorChangedEventArgs<KinectSensor>> KinectSensorChanged
        {
            // ContextEventWrapper<> is already thread safe so no locking
            add { this._kinectSensorChangedContextWrapper.AddHandler(value); }

            remove { this._kinectSensorChangedContextWrapper.RemoveHandler(value); }
        }
        ...
        public event PropertyChangedEventHandler PropertyChanged
        {
            ...
            add
            {
                lock (_lockObject)
                {
                    ...
                    this._propertyChangedContextWrapper.AddHandler(handler);
                }
            }
            ...
            remove
            {
                lock (_lockObject)
                {
                    EventHandler<PropertyChangedEventArgs> handler = _changedHandlers[value];
                    _changedHandlers.Remove(value);
                    this._propertyChangedContextWrapper.RemoveHandler(handler);
                }
            }
        }
        ...
        public string RequiredConnectionId
        {
            get
            {
                return _requiredConnectionId;
            }

            set
            {
                if (value == _requiredConnectionId)
                {
                    return;
                }
                ...
                using (var callbackLock = new CallbackLock(_lockObject))
                {
                    ...
                    if (this.Kinect != null && this.Kinect.DeviceConnectionId == _requiredConnectionId)
                    {
        ...
        private void RaisePropertyChanged(string propertyName)
        {
            ...
            this._propertyChangedContextWrapper.Invoke(this, new PropertyChangedEventArgs(propertyName));
        }
